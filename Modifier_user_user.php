...
<body id="page-top">
    ...
    placeholder="Salaire" value="<?=$Users_target->salaire?>">
                                    ...
                                    <select class="form-control " name="role" id="role">
                                        <option value="patient" <?php if($Users_target->role == "patient") echo "selected" ?> >Patient</option>
                                        <option value="admin" <?php if($Users_target->role == "admin") echo "selected" ?> >Admin</option>
                                    </select>
